...
A Python SDK for the [Have I Been Squatted](https://haveibeensquatted.com) API that provides real-time streaming analysis of domain squatting, unregistered domains, CT Log (Certificate Transparency Log) regex search, and API usage metrics.
