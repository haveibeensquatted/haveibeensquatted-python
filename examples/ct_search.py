...
from haveibeensquatted import HaveIBeenSquatted, HydratedOccurrenceResult, OccurrenceRec
...
async def main_async() -> None:
    ...
    if args.fqdn:
        results = await client.ct_search_domains(args.fqdn, include_precert=args.include_precert)
